...
import { avatarFallback , avatarBg} from "../lib/avatar";
...
function Avatar({ name = "", url, size = 38 }) {
  ...
  return url ? (
    <img src={url} onError={avatarFallback(name)} alt="" loading="lazy" decoding="async" style={{ ...avatarBg(name), width: size, height: size, borderRadius: "50%", objectFit: "cover", border: "1.5px solid var(--line)", flexShrink: 0 }} />
  ) : (
