                ...
                {newbies.map((m) => {
                  ...
                  return (
                    <span key={m.id} onClick={tap} style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "var(--surface2)", border: "1px solid var(--line)", borderRadius: 999, padding: "4px 11px 4px 4px", cursor: tap ? "pointer" : "default" }}>
                      <img src={playerAvatar(full?.avatar_url, m.id)} onError={avatarFallback(m.id)} alt="" style={{ ...avatarBg(m.id), width: 22, height: 22, borderRadius: "50%", objectFit: "cover" }} />
              ...
              <div className="an-card" style={{ marginBottom: 12 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 10 }}>
                  <span style={{ display: "flex", flexShrink: 0 }}>
                    <img src={playerAvatar(pa?.avatar_url, pair.a)} onError={avatarFallback(pair.a)} alt="" style={{ ...avatarBg(pair.a), width: 34, height: 34, borderRadius: "50%", objectFit: "cover", border: "2px solid var(--surface)" }} />
                    <img src={playerAvatar(pb?.avatar_url, pair.b)} onError={avatarFallback(pair.b)} alt="" style={{ ...avatarBg(pair.b), width: 34, height: 34, borderRadius: "50%", objectFit: "cover", border: "2px solid var(--surface)", marginLeft: -10 }} />
                  </span>
