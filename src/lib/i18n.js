...
const T = {
  ru: {
    ...
    pub_footer_q: '🎾 Хочешь организовать свои игры?', pub_footer_cta: 'Создать лигу бесплатно →',
    pub_league_brand: '🎾 ПАДЕЛ · ЛИГА ДРУЗЕЙ', pub_league_notfound_t: 'Лига не найдена',
    ...
    pub_trn_brand: 'ПАДЕЛ · ТУРНИР', pub_trn_notfound: 'Турнир по коду {code} не найден.',
  ...
  en: {
    ...
    pub_footer_q: '🎾 Want to organize your own games?', pub_footer_cta: 'Create a league for free →',
    pub_league_brand: '🎾 PADEL · FRIENDS LEAGUE', pub_league_notfound_t: 'League not found',
    ...
    pub_trn_brand: 'PADEL · TOURNAMENT', pub_trn_notfound: 'Tournament with code {code} not found.',
  ...
  es: {
    ...
    pub_footer_q: '🎾 ¿Quieres organizar tus propios partidos?', pub_footer_cta: 'Crear una liga gratis →',
    pub_league_brand: '🎾 PÁDEL · LIGA DE AMIGOS', pub_league_notfound_t: 'Liga no encontrada',
    ...
    pub_trn_brand: 'PÁDEL · TORNEO', pub_trn_notfound: 'Torneo con código {code} no encontrado.',
