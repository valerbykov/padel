-- app_bootstrap: + is_demo в списке лиг. Без него после холодного старта
-- activeLeague.is_demo пуст, и демо-лига показывала инвайт-карту (код/QR)
-- в «Управлении лигой» и на «Друзьях». Клиент поле уже маппит.
-- Полная замена функции (поверх 2026-07-20_bootstrap_stats.sql).
